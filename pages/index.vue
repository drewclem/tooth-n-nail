		...
		<section class="container mx-auto px-5 lg:px-0 md:py-6 -mt-6">
			<div class="items-center transform translate-x-12 hero-wrapper md:flex">
				...
				>
					...
					<a class="btn" href="tel:478-259-1829">Request Consultation</a>
				</div>
			</div>
		</section>
...
<style lang="postcss" scoped>
	...
	.overflow-gradient {
		...
		background: -moz-linear-gradient(left, rgba(255, 255, 255, 0) 0%, rgba(237, 242, 247, 1) 100%);
		/* FF3.6-15 */
		...
		background: linear-gradient(to right, rgba(255, 255, 255, 0) 0%, rgba(237, 242, 247, 1) 100%);
