...
<template>
	<header class="relative top-0 w-full bg-black-900">
		...
		<HeaderBG class="absolute transition duration-100 ease-in-out pointer-events-none header-bg text-black-900" />
		...
		<div
			...
			<div class="items-center hidden text-sm social-icons lg:flex">
				<a class="items-center hidden mr-4 italic tracking-wide text-yellow-200 transition duration-150 ease-in-out opacity-50 cursor-pointer lg:flex hover:opacity-100 lg:mr-8 font-display"
				...
				<a class="mr-4 transition duration-150 ease-in-out opacity-75 cursor-pointer hover:opacity-100"
		...
		<nav class="absolute block w-full pt-12 pb-4 text-lg italic font-medium text-yellow-200 uppercase transition duration-300 ease-in-out bg-yellow-200 mobile-nav lg:hidden font-display"
			...
			<HeaderBG class="absolute mt-2 text-yellow-200 yellow-under"
